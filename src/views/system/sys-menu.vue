      ...
      <el-col :span="12">
          <el-card shadow="hover">
            ...
            <el-form-item label="菜单名称" prop="menuName">
                <el-input v-model.trim="menuForm.menuName"></el-input>
            </el-form-item>
            <el-form-item label="菜单代码" prop="code">
                <el-input v-model.trim="menuForm.code"></el-input>
            </el-form-item>
            <el-form-item label="路径资源" prop="url">
                <el-input v-model.trim="menuForm.url"></el-input>
            </el-form-item>
            ...
            <el-form-item label="排序" prop="sort">
                <el-input-number v-model="menuForm.sort" :min="1" :max="1000"></el-input-number>
            </el-form-item>
            <el-form-item label="描述" prop="description">
                <el-input v-model.trim="menuForm.description"></el-input>
            </el-form-item>
            <el-form-item right>
